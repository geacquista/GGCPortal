...
User.create = (newUser, result) => {
  ...
  var query = "INSERT INTO `User` (`email`, `password`, `nickname`, `permissionType`) VALUES ('"+newUser.email+"', '"+newUser.password+"','"+newUser.nickname+"' ,'"+newUser.permissionType+"');"
...
User.updateById = (id, user, result) => {
  sql.query(
    "UPDATE User SET email = ?, password = ?, nickname = ?, permissionType = ? WHERE userID = ?",
